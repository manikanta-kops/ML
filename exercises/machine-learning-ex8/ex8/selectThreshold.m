...
for epsilon = min(pval):stepsize:max(pval)
    ...
    %tp - true postive => our algorithm correctly classified it as an anomaly.
    ...
    % it’s an anomaly, but our algorithm incorrectly classified it as not being anoma- lous.
